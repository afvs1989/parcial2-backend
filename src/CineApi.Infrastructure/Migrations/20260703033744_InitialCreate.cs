        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Personaje = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Repartos", x => new { x.PeliculaId, x.ActorId });
                    table.ForeignKey(
                        name: "FK_Repartos_Actores_ActorId",
                        column: x => x.ActorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Peliculas_Titulo_Anio",
                table: "Peliculas",
                columns: new[] { "Titulo", "Anio" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Repartos_ActorId",
                table: "Repartos",
                column: "ActorId");
